            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <select name="size" class="form-control @error('size') is-invalid @enderror" required>
                        <option value="250 gr" {{ old('size', $productVariant->size) == '250 gr' ? 'selected' : '' }}>250 gr</option>
                        <option value="500 gr" {{ old('size', $productVariant->size) == '500 gr' ? 'selected' : '' }}>500 gr</option>
                        <option value="1 kg" {{ old('size', $productVariant->size) == '1 kg' ? 'selected' : '' }}>1 kg</option>
                    </select>
                    @error('size')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                ...
                <div class="form-group">
                    <label>Harga</label>
                    <input type="number" name="price" value="{{ old('price', $productVariant->price) }}"
                ...
                <div class="form-group">
                    <label>Stok</label>
                    <input type="number" name="stock" value="{{ old('stock', $productVariant->stock) }}"
