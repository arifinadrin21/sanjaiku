...
<style>
    ...
    .voucher-form-wrapper .form-control[readonly] {
        background: #f8fafc;
        color: #94a3b8;
    }
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <select name="type" class="form-control">
                        ...
                        <option value="nominal"
                            {{ $voucher->type == 'nominal' ? 'selected' : '' }}>
                            Nominal
                        </option>

                        <option value="percent"
                            {{ $voucher->type == 'percent' ? 'selected' : '' }}>
                            Persentase
                        </option>
                ...
                <div class="form-group">
                    ...
                    <input
                        ...
                        name="start_date"
                        class="form-control"
                        value="{{ $voucher->start_date->format('Y-m-d') }}"
                        required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input
                        ...
                        name="expired_date"
                        class="form-control"
                        value="{{ $voucher->expired_date->format('Y-m-d') }}"
                        required>
                </div>
