...
<link rel="stylesheet"
    ...
    {{-- Override warna teks & aksen menu sidebar — hanya styling, tidak mengubah struktur/fitur apa pun --}}
    <style>
        ...
        /* Judul section seperti "MASTER DATA", "TRANSAKSI", dll */
        .nav-sidebar .nav-header {
            color: #8b93a7 !important;
        }

        /* Menu aktif: kuning, senada tombol "Tambah Kategori/Produk/Varian/Voucher" */
